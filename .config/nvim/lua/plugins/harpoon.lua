return {
  ...
  config = function()
    ...
    vim.keymap.set("n", "H", function() harpoon:list():prev({ui_nav_wrap= true}) end, {desc = "Prev harpooned file"})
    vim.keymap.set("n", "L", function() harpoon:list():next({ui_nav_wrap= true}) end, {desc = "Next harpooned file"})
